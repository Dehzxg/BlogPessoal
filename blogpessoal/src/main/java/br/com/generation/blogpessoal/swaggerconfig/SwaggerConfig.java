...
package  br.com.generation.blogpessoal.swaggerconfig;
...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			...
			.description("Projeto BlogPessoal - DCHZXG")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("https://github.com/Dehzxg")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("André Santos", 
			"https://github.com/Dehzxg", 
			"andre.santos610@outlook.com");
